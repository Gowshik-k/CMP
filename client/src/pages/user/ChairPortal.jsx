        ...
        return (
            <div className="flex-1 flex flex-col gap-8 animate-fade-in pb-12">
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <button className="flex items-center gap-2 px-6 py-3 bg-zinc-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-500/10">
                    ...
                    {conferences.map(conf => (
                        <div key={conf._id} className="bg-white p-8 rounded-[3rem] border border-zinc-200 shadow-sm group hover:shadow-2xl hover:shadow-emerald-500/5 hover:-translate-y-1 transition-all duration-300">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button className="p-4 bg-zinc-50 text-zinc-400 rounded-2xl hover:bg-zinc-100 hover:text-zinc-600 transition-all">
